# Codex Workflow: review-pr

Migrated from `.claude/commands/review-pr.md`.
...
`.codex/workflows/review-pr.md`". Preserve safety checks and user-confirmation gates
for destructive GitHub or git operations.

## Missing referenced source files

The original Claude command references these files, which were not present in the observed tree:
- `.claude/data/review-pr-change-types.md`
- `.claude/data/review-pr-templates.md`

The references are preserved below as source context, but execution should treat them as unresolved unless the files are later restored.
